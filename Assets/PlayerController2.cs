...
public class PlayerController2 : MonoBehaviour
{
    ...
    private Touch touch;                       //Ref to EndGameCanvas that brings up scores and restart/home buttons
    ...
    /// </summary>
    public void SwitchPlayerColor2()
    {
    ...
    void OnCollisionEnter(Collision col)
    {
        ...
        if (!testingMode)
        {
            ...
            Invoke("ShowEndGameCanvasAndScore", 0.4f);
        }
        else
        {
